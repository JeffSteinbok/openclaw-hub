...
export async function createMeeting(
  ...
  const created = await graphPost(token, "/me/events", eventObj) as Record<string, unknown>;
...
export async function updateEvent(
  ...
  if (params.event_id) {
    ...
    currentEvent = await graphGet(token, `/me/events/${encodeURIComponent(eventId)}`) as Record<string, unknown>;
  ...
  const updated = await graphPatch(token, `/me/events/${encodeURIComponent(eventId)}`, patch) as Record<string, unknown>;
...
// ---------------------------------------------------------------------------
// Private helpers for calendar tools
// ---------------------------------------------------------------------------
