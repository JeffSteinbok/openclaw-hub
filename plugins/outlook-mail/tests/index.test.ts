...
describe("plugin entry", () => {
  ...
  it("registers all 9 tools", async () => {
    ...
    expect(Object.keys(api.tools).sort()).toEqual(["outlook_flag","outlook_forward","outlook_inbox","outlook_move","outlook_read","outlook_reply","outlook_save_attachments","outlook_search","outlook_send"]);
  });
});
